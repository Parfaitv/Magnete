import { GridBox, TextManrope, FlexBox, AdvertisingBlock } from "@/components"
import { useAppSelector } from "@/store"
import { useCSSMedia } from "@/utils"

export const AboutPage = () => {
    const isMobile = useCSSMedia()
    const { advertisingBlock, description, title } = useAppSelector((state) => state.reducer.aboutPage)
    return (
