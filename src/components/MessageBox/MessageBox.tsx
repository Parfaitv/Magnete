...
export const MessageBox = ({ title, telegramUrl, instagramUrl }: { title: string, telegramUrl: string, instagramUrl: string }) => {
    return (
        <FlexBox height='4.7em' width='100%' bgcolor='#221121' justifyContent='center' gap='3rem' alignItems='center'>
            <TextManrope sx={{
                textWrap: 'balance'
            }} color='#fff'>
                {title}
            </TextManrope>
            <FlexBox justifyContent='space-between' alignItems='center' gap='30px'>
